...
namespace DBHelper
{
    public partial class MysqlHelper : BaseHelper
    {
        ...
        public static bool Insert<T>(T t, string TableName = null)
        {
            ...
            MySqlParameterCollection sqlParamCollection = new MySqlCommand().Parameters;
            Type type = typeof(T);
            ...
            foreach (PropertyInfo p in pi)
            {
                ...
                if (value != null && !hasAutoIncre && !hasInvalid)
                {
                    ...
                    sqlParamCollection.Add(new MySqlParameter("@" + name, value));
                }
            }
            ...
            int result = MysqlHelper.ExecteNonQuery(sql, null, System.Data.CommandType.Text, sqlParamCollection);
        ...
        public static int Update<T>(T t, T where, string TableName = null)
        {
            ...
            string wherecondition = "";
            MySqlParameterCollection sqlParamCollection = new MySqlCommand().Parameters;
            MySqlParameterCollection sqlwhereParamCollection = new MySqlCommand().Parameters;
            Type type = typeof(T);
            PropertyInfo[] pi = type.GetProperties();
            ...
            foreach (PropertyInfo p in pi)
            {
                ...
                if (where == null)
                {
                    ...
                    if (hasKey)
                    {
                        ...
                        sqlParamCollection.Add(new MySqlParameter("@" + name + "2", value));
                    }
                }
                ////////////////////////////
                if (where != null)
                {
                    ...
                    {
                        wherecondition += " and " + name + "=@" + name + "2";
                        sqlParamCollection.Add(new MySqlParameter("@" + name + "2", whereValue));
                    }
                }
        ...
        public static int Delete<T>(T t, string TableName = null)
        {
            ...
            int r = MysqlHelper.ExecteNonQuery(sql, null, CommandType.Text, sqlParamCollection);
            return r;
        }
